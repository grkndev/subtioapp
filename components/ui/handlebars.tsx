  ...
  return (
    <div className="flex justify-center gap-4 leading-16">
      <div ref={containerRef} className="relative -rotate-[2.76deg] mt-0.5">
        <div className="absolute inset-0 w-full h-full rounded-2xl border border-subtio-gold flex justify-between z-1">
          <motion.div
            className="absolute z-10 left-0 h-full border border-subtio-gold w-7 rounded-full bg-background flex items-center justify-center select-none"
            style={{
              x: leftHandleX,
            }}
            drag="x"
          ...
          >
            <div className="w-2 h-8 rounded-full bg-subtio-gold" />
          </motion.div>

          <motion.div
            className="absolute z-10 -left-[30px] h-full border border-subtio-gold w-7 rounded-full bg-background flex items-center justify-center select-none"
            style={{
              x: rightHandleX,
            }}
            drag="x"
